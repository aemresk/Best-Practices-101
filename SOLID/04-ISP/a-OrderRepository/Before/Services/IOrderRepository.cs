// ❌ ISP İHLALİ: Tek şişman interface — okuma, yazma ve raporlama bir arada
// ReadOnlyDashboard yalnızca GetAll + GetSummary kullanıyor ama Add/Update/Delete'i implement etmek zorunda
// AuditRepository yalnızca GetAll kullanıyor ama 6 metodu implement etmek zorunda
...
// ✅ Tam implementasyon — tüm metodları destekliyor
...
// ❌ ISP İHLALİ: Dashboard yalnızca okuma + rapor kullanıyor
// Ama interface gereği Add/Update/Delete implement etmek ZORUNDA
public class DashboardOrderRepository : IOrderRepository
{
    ...
    // ❌ Kullanmıyorum ama interface beni zorluyor
    public void Add(Order order)    => throw new NotImplementedException("Dashboard salt okunur");
    public void Update(Order order) => throw new NotImplementedException("Dashboard salt okunur");
    public void Delete(int id)      => throw new NotImplementedException("Dashboard salt okunur");
}
